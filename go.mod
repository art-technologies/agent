...
require (
	...
	github.com/grafana/loki v1.6.2-0.20221031191413-16761723f4f2
...
replace github.com/prometheus/prometheus => github.com/grafana/prometheus v1.8.2-0.20221031173322-8c5a3049b4b9
